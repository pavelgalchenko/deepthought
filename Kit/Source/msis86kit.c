...
/* Subroutine */ int gts5_0_(int n__, integer *iyd, real *sec, real *alt,
   ...
   static real altl[8]   = {200.f, 400.f, 150.f, 200.f,
   ...
   static real g1, g4, b01, b04, b32, b16, g40, b28, g32, g16, b40, g14, g28,
       b14, tz, hc04, hc32, hc16, hc40, dm04, dm32, dm16, dm40, dm01, dm28,
       rc16, hc01, zc04, zc16, zh04, tr12, xmd, zh16, zh28, yrd, zh32, xmm,
       zc32, zh40, zc40, zh01, zc01, rc01, zh14, dm14, hc14, zc14, rc14, hcc01,
       hcc14, hcc16, zcc01, zcc14;
   ...
   extern doublereal denss_(real *, real *, real *, real *, real *, real *,
                            ...
                            real *),
       globe5_(real *, real *, real *, real *, real *, real *, real *, real *,
               real *),
       glob5l_(real *);
...
L5:
   ...
   /*       Eq. A7 */
   tinf = lower5_1.ptm[0] *
          (csw_1.sw[15] * globe5_(&yrd, sec, glat, glong, stl, f107a, f107,
                                  &ap[1], parm5_1.pt) +
           1.f) *
          parm5_1.pt[0];
   gts3c_1.za = lower5_1.ptm[4] * parm5_1.pdl[40];
   /*       Eq. A9 */
   gts3c_1.t0 = lower5_1.ptm[2] * parm5_1.pd[375] *
                (csw_1.sw[17] * glob5l_(&parm5_1.pd[375]) + 1.f);
   /*       Eq. A8 */
   gts3c_1.tlb = lower5_1.ptm[1] *
                 (csw_1.sw[16] * glob5l_(&parm5_1.pd[325]) + 1.f) *
                 parm5_1.pd[325];
   /*       Eq. A10 */
   gts3c_1.z0 = lower5_1.ptm[6] *
                (csw_1.sw[19] * glob5l_(&parm5_1.pd[350]) + 1.f) *
                parm5_1.pd[350];
   /*       Eq. A6 */
   gts3c_1.g0 = lower5_1.ptm[3] * parm5_1.ps[0] *
                (csw_1.sw[18] * globe5_(&yrd, sec, glat, glong, stl, f107a,
                                        f107, &ap[1], parm5_1.ps) +
                 1.f);
   /*       Eq. A5 */
...
L15:
   ...
   /*       Eq. A13 - A17 */
   d__[3] = denss_(alt, &gts3c_1.db28, &tinf, &gts3c_1.tlb, &c_b8, &c_b9, &t[2],
...
L20:
   ...
   zh04 = lower5_1.pdm[2];
   r__1 = 4.f - xmm;
   b04 = denss_(&zh04, &gts3c_1.db04, &tinf, &gts3c_1.tlb, &r__1, &c_b22, &t[2],
                &lower5_1.ptm[5], &gts3c_1.s, &gts3c_1.t0, &gts3c_1.za,
                &gts3c_1.z0, &tr12);
...
L25:
   ...
   r__1 = 16 - xmm;
   b16 = denss_(&zh16, &gts3c_1.db16, &tinf, &gts3c_1.tlb, &r__1, &c_b10, &t[2],
                &lower5_1.ptm[5], &gts3c_1.s, &gts3c_1.t0, &gts3c_1.za,
                &gts3c_1.z0, &tr12);
...
L35:
   ...
   r__1 = 32.f - xmm;
   b32 = denss_(&zh32, &gts3c_1.db32, &tinf, &gts3c_1.tlb, &r__1, &c_b10, &t[2],
                &lower5_1.ptm[5], &gts3c_1.s, &gts3c_1.t0, &gts3c_1.za,
                &gts3c_1.z0, &tr12);
...
L40:
   ...
   r__1 = 40.f - xmm;
   b40 = denss_(&zh40, &gts3c_1.db40, &tinf, &gts3c_1.tlb, &r__1, &c_b10, &t[2],
                &lower5_1.ptm[5], &gts3c_1.s, &gts3c_1.t0, &gts3c_1.za,
                &gts3c_1.z0, &tr12);
...
L45:
   ...
   /*       Eq. A18 */
   g1 = csw_1.sw[20] * globe5_(&yrd, sec, glat, glong, stl, f107a, f107, &ap[1],
                               &parm5_1.pd[750]);
   ...
   r__1 = 1.f - xmm;
   b01 = denss_(&zh01, &gts3c_1.db01, &tinf, &gts3c_1.tlb, &r__1, &c_b22, &t[2],
                &lower5_1.ptm[5], &gts3c_1.s, &gts3c_1.t0, &gts3c_1.za,
                &gts3c_1.z0, &tr12);
...
L48:
   ...
   r__1 = 14.f - xmm;
   b14 = denss_(&zh14, &gts3c_1.db14, &tinf, &gts3c_1.tlb, &r__1, &c_b10, &t[2],
                &lower5_1.ptm[5], &gts3c_1.s, &gts3c_1.t0, &gts3c_1.za,
                &gts3c_1.z0, &tr12);
...
L49:
   ...
   d__[6] = (d__[1] * 4.f + d__[2] * 16.f + d__[3] * 28.f + d__[4] * 32.f +
             d__[5] * 40.f + d__[7] + d__[8] * 14.f) *
            1.66e-24f;
   gts3c_1.db48 = (gts3c_1.db04 * 4.f + gts3c_1.db16 * 16.f +
                   gts3c_1.db28 * 28.f + gts3c_1.db32 * 32.f +
                   gts3c_1.db40 * 40.f + gts3c_1.db01 + gts3c_1.db14 * 14.f) *
                  1.66e-24f;
   goto L90;
L50:
   denss_(alt, &c_b43, &tinf, &gts3c_1.tlb, &c_b9, &c_b9, &t[2],
          &lower5_1.ptm[5], &gts3c_1.s, &gts3c_1.t0, &gts3c_1.za, &gts3c_1.z0,
          &tr12);
   goto L90;
L90:
   if (imr == 1) {
...
doublereal denss_(real *alt, real *dlb, real *tinf, real *tlb, real *xm,
   ...
   *tz     = tt;
   ...
   /* Computing 2nd power */
   r__1 = ta;
   dd   = zg0 * .666666f * dta / (r__1 * r__1) -
        (1.f / ta - 1.f / *t0) * 3.11111f + (1.f / t12 - 1.f / *t0) * 7.11111f;
   /*      Eq. A3b */
...
L20:
   ...
   ret_val = densa * pow(d__1, d__2) *
             exp(gamm * ((x - 1) / *t0 + bb * (x * x2 - 1.f) / 3.f +
                         cc * (x2 * x2 * x - 1.f) / 5.f +
                         dd * (x2 * x2 * x2 * x - 1.f) / 7.f));
L50:
...
doublereal globe5_(real *yrd, real *sec, real *lat, real *long__, real *tloc,
   ...
   static real sv[25] = {1.f, 1.f, 1.f, 1.f, 1.f, 1.f, 1.f, 1.f, 1.f,
   ...
   static real c__;
   static integer i__;
   static real s, c2, c4, f1, f2, s2, p44, p45, t71, t72, t81, t82, cd14, cd32,
       cd18, cd39, exp1, exp2;
   /* static real c2d14; */
   ...
   lpoly_1.plg[5] = (c2 * 63.f * c2 * c__ - c2 * 70.f * c__ + c__ * 15.f) / 8.f;
   lpoly_1.plg[6] = (c__ * 11.f * lpoly_1.plg[5] - lpoly_1.plg[4] * 5.f) / 6.f;
   lpoly_1.plg[10] = s;
   ...
   lpoly_1.plg[15] =
       (c__ * 11.f * lpoly_1.plg[14] - lpoly_1.plg[13] * 6.f) / 5.f;
   ...
   lpoly_1.plg[24] =
       (c__ * 11.f * lpoly_1.plg[23] - lpoly_1.plg[22] * 7.f) / 4.f;
   lpoly_1.plg[25] =
       (c__ * 13.f * lpoly_1.plg[24] - lpoly_1.plg[23] * 8.f) / 5.f;
   lpoly_1.plg[30] = s2 * 15.f * s;
   lpoly_1.plg[31] = s2 * 105.f * s * c__;
   lpoly_1.plg[32] =
       (c__ * 9.f * lpoly_1.plg[31] - lpoly_1.plg[30] * 7.f) / 2.f;
   lpoly_1.plg[33] =
       (c__ * 11.f * lpoly_1.plg[32] - lpoly_1.plg[31] * 8.f) / 3.f;
   xl = *lat;
L15:
   if (tll == *tloc) {
      goto L16;
...
L16:
   ...
   /* Computing 2nd power */
   r__1         = lpoly_1.dfa;
   ttest_2.t[0] = p[20] * lpoly_1.df + p[21] * lpoly_1.df * lpoly_1.df +
                  p[22] * lpoly_1.dfa + p[30] * (r__1 * r__1);
   f1 = (p[48] * lpoly_1.dfa + p[20] * lpoly_1.df +
         p[21] * lpoly_1.df * lpoly_1.df) *
            csw_1.swc[0] +
        1.f;
   f2 = (p[50] * lpoly_1.dfa + p[20] * lpoly_1.df +
         p[21] * lpoly_1.df * lpoly_1.df) *
            csw_1.swc[0] +
        1.f;
   /*        TIME INDEPENDENT */
   ttest_2.t[1] = p[2] * lpoly_1.plg[2] + p[3] * lpoly_1.plg[4] +
                  p[23] * lpoly_1.plg[6] +
                  p[15] * lpoly_1.plg[2] * lpoly_1.dfa * csw_1.swc[0] +
                  p[27] * lpoly_1.plg[1];
   /*        SYMMETRICAL ANNUAL */
   ...
   /*        ASYMMETRICAL ANNUAL */
   ttest_2.t[4] = f1 * (p[10] * lpoly_1.plg[1] + p[11] * lpoly_1.plg[3]) * cd14;
   ...
   t72 = (p[13] * lpoly_1.plg[11] + p[37] * lpoly_1.plg[10]) * cd14 *
         csw_1.swc[4];
   ttest_2.t[6] = f2 * ((p[4] * lpoly_1.plg[10] + p[5] * lpoly_1.plg[12] +
                         p[28] * lpoly_1.plg[14] + t71) *
                            lpoly_1.ctloc +
                        (p[7] * lpoly_1.plg[10] + p[8] * lpoly_1.plg[12] +
                         p[29] * lpoly_1.plg[14] + t72) *
                            lpoly_1.stloc);
   /*        SEMIDIURNAL */
   t81 = p[24] * lpoly_1.plg[21] * cd14 * csw_1.swc[4];
   t82 = p[34] * lpoly_1.plg[21] * cd14 * csw_1.swc[4];
   ttest_2.t[7] =
       f2 * ((p[6] * lpoly_1.plg[20] + p[42] * lpoly_1.plg[22] + t81) *
                 lpoly_1.c2tloc +
             (p[9] * lpoly_1.plg[20] + p[43] * lpoly_1.plg[22] + t82) *
                 lpoly_1.s2tloc);
   /*        TERDIURNAL */
   ttest_2.t[13] = f2 * ((p[40] * lpoly_1.plg[30] +
                          (p[94] * lpoly_1.plg[31] + p[47] * lpoly_1.plg[33]) *
                              cd14 * csw_1.swc[4]) *
                             lpoly_1.s3tloc +
                         (p[41] * lpoly_1.plg[30] +
                          (p[95] * lpoly_1.plg[31] + p[49] * lpoly_1.plg[33]) *
                              cd14 * csw_1.swc[4]) *
                             lpoly_1.c3tloc);
   ...
   lpoly_1.apdf =
       lpoly_1.apd +
       (p45 - 1.f) * (lpoly_1.apd + (exp(-p44 * lpoly_1.apd) - 1.f) / p44);
   ttest_2.t[8] =
       lpoly_1.apdf * (p[33] + p[46] * lpoly_1.plg[2] + p[35] * lpoly_1.plg[4] +
                       (p[101] * lpoly_1.plg[1] + p[102] * lpoly_1.plg[3] +
                        p[103] * lpoly_1.plg[5]) *
                           cd14 * csw_1.swc[4] +
                       (p[122] * lpoly_1.plg[10] + p[123] * lpoly_1.plg[12] +
                        p[124] * lpoly_1.plg[14]) *
                           csw_1.swc[6] * cos(hr * (*tloc - p[125])));
   goto L40;
L30:
   if (p[52] == 0.f) {
      goto L40;
   ...
   r__5 = exp1, r__6 = r__5, r__5 *= r__5, r__6 *= r__5, r__5 *= r__5,
   r__5 *= r__5;
   ...
   lpoly_1.apt[0] =
       (ap[2] - 4.f +
        (p[26] - 1.f) *
            (ap[2] - 4.f +
             (exp(-dabs(p[25]) * (ap[2] - 4.f)) - 1.f) / dabs(p[25])) +
        ((ap[3] - 4.f +
          (p[26] - 1.f) *
              (ap[3] - 4.f +
               (exp(-dabs(p[25]) * (ap[3] - 4.f)) - 1.f) / dabs(p[25]))) *
             exp1 +
         (ap[4] - 4.f +
          (p[26] - 1.f) *
              (ap[4] - 4.f +
               (exp(-dabs(p[25]) * (ap[4] - 4.f)) - 1.f) / dabs(p[25]))) *
             exp1 * exp1 +
         (ap[5] - 4.f +
          (p[26] - 1.f) *
              (ap[5] - 4.f +
               (exp(-dabs(p[25]) * (ap[5] - 4.f)) - 1.f) / dabs(p[25]))) *
             (r__1 * (r__1 * r__1)) +
         ((ap[6] - 4.f +
           (p[26] - 1.f) *
               (ap[6] - 4.f +
                (exp(-dabs(p[25]) * (ap[6] - 4.f)) - 1.f) / dabs(p[25]))) *
              (r__2 * r__2) +
          (ap[7] - 4.f +
           (p[26] - 1.f) *
               (ap[7] - 4.f +
                (exp(-dabs(p[25]) * (ap[7] - 4.f)) - 1.f) / dabs(p[25]))) *
              (r__3 * (r__3 * r__3))) *
             (1.f - r__4 * r__4) / (1.f - exp1))) /
       (1.f + (1.f - r__6 * (r__5 * r__5)) / (1.f - exp1) * pow(d__1, c_b71));
   /* Computing 3rd power */
   r__1 = exp2;
   /* Computing 4th power */
   r__2 = exp2, r__2 *= r__2;
   ...
   /* Computing 19th power */
   r__5 = exp2, r__6 = r__5, r__5 *= r__5, r__6 *= r__5, r__5 *= r__5,
   r__5 *= r__5;
          ...
          (ap[7] - 4.f +
           (p[26] - 1.f) *
               (ap[7] - 4.f +
                (exp(-dabs(p[25]) * (ap[7] - 4.f)) - 1.f) / dabs(p[25]))) *
              (r__3 * (r__3 * r__3))) *
             (1.f - r__4 * r__4) / (1.f - exp2))) /
       (1.f + (1.f - r__6 * (r__5 * r__5)) / (1.f - exp2) * pow(d__1, c_b71));
   ttest_2.t[8] = lpoly_1.apt[0] *
                  (p[51] + p[97] * lpoly_1.plg[2] + p[55] * lpoly_1.plg[4] +
                   (p[126] * lpoly_1.plg[1] + p[127] * lpoly_1.plg[3] +
                    p[128] * lpoly_1.plg[5]) *
                       cd14 * csw_1.swc[4] +
                   (p[129] * lpoly_1.plg[10] + p[130] * lpoly_1.plg[12] +
                    p[131] * lpoly_1.plg[14]) *
                       csw_1.swc[6] * cos(hr * (*tloc - p[132])));
L40:
   if (csw_1.sw[9] == 0.f || *long__ <= -1e3f) {
      goto L49;
   }
   /*        LONGITUDINAL */
   ttest_2.t[10] = (p[90] * lpoly_1.plg[1] + 1.f) *
                   (p[81] * lpoly_1.dfa * csw_1.swc[0] + 1.f) *
                   ((p[65] * lpoly_1.plg[11] + p[66] * lpoly_1.plg[13] +
                     p[67] * lpoly_1.plg[15] + p[104] * lpoly_1.plg[10] +
                     p[105] * lpoly_1.plg[12] + p[106] * lpoly_1.plg[14] +
                     csw_1.swc[4] *
                         (p[110] * lpoly_1.plg[10] + p[111] * lpoly_1.plg[12] +
                          p[112] * lpoly_1.plg[14]) *
                         cd14) *
                        cos(dgtr * *long__) +
                    (p[91] * lpoly_1.plg[11] + p[92] * lpoly_1.plg[13] +
                     p[93] * lpoly_1.plg[15] + p[107] * lpoly_1.plg[10] +
                     p[108] * lpoly_1.plg[12] + p[109] * lpoly_1.plg[14] +
                     csw_1.swc[4] *
                         (p[113] * lpoly_1.plg[10] + p[114] * lpoly_1.plg[12] +
                          p[115] * lpoly_1.plg[14]) *
                         cd14) *
                        sin(dgtr * *long__));
   /*        UT AND MIXED UT,LONGITUDE */
   ttest_2.t[11] = (p[96] * lpoly_1.plg[1] + 1.f) *
                   (p[82] * lpoly_1.dfa * csw_1.swc[0] + 1.f) *
                   (p[120] * lpoly_1.plg[1] * csw_1.swc[4] * cd14 + 1.f) *
                   ((p[69] * lpoly_1.plg[1] + p[70] * lpoly_1.plg[3] +
                     p[71] * lpoly_1.plg[5]) *
                    cos(sr * (*sec - p[72])));
   ttest_2.t[11] += csw_1.swc[10] *
                    (p[77] * lpoly_1.plg[21] + p[78] * lpoly_1.plg[23] +
                     p[79] * lpoly_1.plg[25]) *
                    cos(sr * (*sec - p[80]) + dgtr * 2.f * *long__) *
                    (p[138] * lpoly_1.dfa * csw_1.swc[0] + 1.f);
   /*        UT,LONGITUDE MAGNETIC ACTIVITY */
   if (sw9 == -1.f) {
      goto L45;
   }
   ttest_2.t[12] = lpoly_1.apdf * csw_1.swc[10] *
                       (p[121] * lpoly_1.plg[1] + 1.f) *
                       ((p[61] * lpoly_1.plg[11] + p[62] * lpoly_1.plg[13] +
                         p[63] * lpoly_1.plg[15]) *
                        cos(dgtr * (*long__ - p[64]))) +
                   lpoly_1.apdf * csw_1.swc[10] * csw_1.swc[4] *
                       (p[116] * lpoly_1.plg[10] + p[117] * lpoly_1.plg[12] +
                        p[118] * lpoly_1.plg[14]) *
                       cd14 * cos(dgtr * (*long__ - p[119])) +
                   lpoly_1.apdf * csw_1.swc[11] *
                       (p[84] * lpoly_1.plg[1] + p[85] * lpoly_1.plg[3] +
                        p[86] * lpoly_1.plg[5]) *
                       cos(sr * (*sec - p[76]));
   goto L48;
L45:
   ...
   ttest_2.t[12] = lpoly_1.apt[0] * csw_1.swc[10] *
                       (p[133] * lpoly_1.plg[1] + 1.f) *
                       ((p[53] * lpoly_1.plg[11] + p[99] * lpoly_1.plg[13] +
                         p[68] * lpoly_1.plg[15]) *
                        cos(dgtr * (*long__ - p[98]))) +
                   lpoly_1.apt[0] * csw_1.swc[10] * csw_1.swc[4] *
                       (p[134] * lpoly_1.plg[10] + p[135] * lpoly_1.plg[12] +
                        p[136] * lpoly_1.plg[14]) *
                       cd14 * cos(dgtr * (*long__ - p[137])) +
                   lpoly_1.apt[0] * csw_1.swc[11] *
                       (p[56] * lpoly_1.plg[1] + p[57] * lpoly_1.plg[3] +
                        p[58] * lpoly_1.plg[5]) *
                       cos(sr * (*sec - p[59]));
L48:
...
L49:
   ...
   for (i__ = 1; i__ <= i__1; ++i__) {
      /* L50: */
      ttest_2.tinf +=
          (r__1 = csw_1.sw[i__ - 1], dabs(r__1)) * ttest_2.t[i__ - 1];
   }
...
doublereal glob5l_(real *p) {
   ...
   static real dr    = .0172142f;
   static real t[15] = {0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f,
   ...
   t[5] = 0.f;
   t[6] = p[14] * lpoly_1.plg[10] * lpoly_1.ctloc +
          p[15] * lpoly_1.plg[10] * lpoly_1.stloc;
   t[7] = (p[16] * lpoly_1.plg[20] + p[18] * lpoly_1.plg[22] +
           p[20] * lpoly_1.plg[23] * cd11 * csw_1.swc[4]) *
              lpoly_1.c2tloc +
          (p[17] * lpoly_1.plg[20] + p[19] * lpoly_1.plg[22] +
           p[21] * lpoly_1.plg[23] * cd11 * csw_1.swc[4]) *
              lpoly_1.s2tloc;
   t[13] = p[12] * lpoly_1.plg[30] * lpoly_1.c3tloc +
           p[25] * lpoly_1.plg[30] * lpoly_1.s3tloc;
   if (csw_1.sw[8] == 1.f) {
      t[8] = lpoly_1.apdf * (p[23] + p[24] * lpoly_1.plg[2] * csw_1.swc[1]);
   }
   if (csw_1.sw[8] == -1.f) {
      t[8] = p[3] * lpoly_1.apt[2] +
             p[5] * lpoly_1.plg[2] * lpoly_1.apt[2] * csw_1.swc[1];
   }
   /*       PARMS NOT USED: 13 */
   tt = 0.f;
...
void InitMSIS86(void) {
   ...
   real lower5_e1[64] = {
       1041.3f,   386.f,       190.f, 16.6728f, 115.f,  120.f, 94.5537f, 0.f,
       2.456e7f,  6.71072e-6f, 100.f, 0.f,      110.f,  10.f,  0.f,      0.f,
       8.594e10f, .54f,        105.f, -8.f,     110.f,  10.f,  90.f,     2.f,
       2.81e11f,  0.f,         105.f, 28.f,     28.95f, 0.f,   0.f,      0.f,
       3.3e10f,   .26827f,     105.f, 0.f,      110.f,  10.f,  0.f,      0.f,
       1.33e9f,   .0119615f,   105.f, 0.f,      110.f,  10.f,  0.f,      0.f,
       176100.f,  1.f,         95.f,  -8.f,     110.f,  10.f,  90.f,     2.f,
       1e7f,      1.f,         105.f, -8.f,     110.f,  10.f,  90.f,     2.f};

   real parm5_e1[1400] = {
       .99604f,      .0385528f,    .00303445f,   -.105531f,    -.00607134f,
       -5.16278e-4f, -.115622f,    .0020224f,    .00990156f,   -.127371f,
       -.0302449f,   .0123512f,    -.00526277f,  -8.45398f,    0.f,
       .014237f,     0.f,          125.818f,     .00805486f,   .00164419f,
       -6.21452e-6f, .00311701f,   0.f,          .00386578f,   .132397f,
       .213315f,     0.f,          0.f,          0.f,          -6.4111e-6f,
       0.f,          30.015f,      .00533297f,   .00389146f,   .00204725f,
       0.f,          0.f,          -.0192645f,   2.75905f,     .00147284f,
       3.41345e-4f,  -.00117388f,  -3.54589e-4f, .113139f,     .169134f,
       .00508295f,   3.65016e-5f,  .00426385f,   1.15102e-4f,  .00511819f,
       .00609108f,   4.04995e-5f,  .00153049f,   2.4147e-5f,   .00230764f,
       .00155267f,   .00133722f,   -.00182318f,  -263.007f,    0.f,
       .00137337f,   9.95774e-4f,  0.f,          -108.983f,    .00562606f,
       .00594053f,   .00109358f,   0.f,          -.013341f,    -.0243409f,
       -.0135688f,   31137.f,      0.f,          0.f,          0.f,
       -2830.23f,    8.45583e-4f,  5.38706e-4f,  0.f,          247.956f,
       .00292246f,   0.f,          0.f,          7.47703e-5f,  8.87993e-4f,
       0.f,          0.f,          0.f,          0.f,          0.f,
       -.011654f,    -.00449173f,  -3.53189e-4f, -1.73933e-4f, -1.53218e-4f,
       -.565411f,    .00777272f,   -91.1784f,    6.45187e-4f,  0.f,
       -8.37685e-4f, .00242318f,   .00473796f,   -.00301801f,  -.00423564f,
       -.00248289f,  9.19286e-4f,  .00216372f,   8.63968e-4f,  .00189689f,
       .00415654f,   0.f,          .0118068f,    .0033119f,    0.f,
       .00120222f,   0.f,          0.f,          -3.07246f,    0.f,
       0.f,          6.72403e-4f,  .0010893f,    9.72278e-4f,  4.68242f,
       -3.15034e-4f, .00400059f,   .00515036f,   .00162989f,   .00108824f,
       9.95261e-4f,  4.18955f,     -.364059f,    .00170182f,   0.f,
       0.f,          -3.2012f,     0.f,          .00580206f,   0.f,
       0.f,          0.f,          0.f,          0.f,          0.f,
       0.f,          0.f,          0.f,          0.f,          0.f,
       1.04934f,     -.0288362f,   -.207095f,    -.103314f,    -.00702373f,
       .0129664f,    .408853f,     -.00919895f,  -.018866f,    1.40927f,
       .175033f,     .0187351f,    .110979f,     -7.42871f,    0.f,
       .267143f,     -.0595979f,   105.038f,     -.0840963f,   -6.97632e-4f,
       2.06521e-6f,  7.65306e-4f,  0.f,          0.f,          .126762f,
       .128876f,     -.0504479f,   -.0130735f,   -.0224348f,   0.f,
       0.f,          -150.832f,    -.00629928f,  0.f,          -.0040776f,
       0.f,          0.f,          .0525725f,    -31.1486f,    -.00313351f,
       .00275838f,   0.f,          0.f,          .111247f,     .108815f,
       -.0466713f,   0.f,          -.00329329f,  0.f,          .00167838f,
       -.00916691f,  3.45044e-5f,  -.00971806f,  0.f,          -.00204672f,
       -.00786899f,  -.00798285f,  .00536515f,   -5311.72f,    0.f,
       -.00642781f,  -.0017169f,   0.f,          -67.9131f,    -.0179912f,
       -.0158305f,   -.00712313f,  0.f,          .0253477f,    .085296f,
       .102163f,     29500.9f,     0.f,          0.f,          0.f,
       -6846.25f,    -.00619098f,  -.00269289f,  0.f,          -520.231f,
       -.00633463f,  0.f,          0.f,          -.00602428f,  -.00407077f,
       .00542264f,   0.f,          0.f,          0.f,          0.f,
       .040756f,     .0282288f,    .00908088f,   0.f,          0.f,
       -.405204f,    -.0597931f,   -73.1823f,    -.0020662f,   0.f,
       -.00372723f,  -.0188146f,   -.0101794f,   .00804633f,   .010109f,
       .00873253f,   .0238268f,    .00480444f,   .00171088f,   .0396369f,
       -.0213809f,   0.f,          -.102588f,    -.00591702f,  0.f,
       .00270923f,   0.f,          0.f,          -175.043f,    .603489f,
       -.617589f,    .00838098f,   .00183871f,   -7.05329e-4f, -4.06644f,
       -.00509347f,  -.0284344f,   -.012416f,    .0133665f,    .0039341f,
       -5.03723e-4f, -4.57683f,    -.529542f,    -.00425812f,  0.f,
       0.f,          19.1541f,     0.f,          .00323247f,   0.f,
       0.f,          0.f,          0.f,          0.f,          0.f,
       0.f,          0.f,          0.f,          0.f,          0.f,
       .931113f,     -.138721f,    -.133457f,    -.0529542f,   -.00444983f,
       .0135264f,    .0598075f,    -.036288f,    -.0312798f,   .372068f,
       .0295974f,    .0120509f,    .0521995f,    -7.78888f,    0.f,
       .118634f,     -.0204495f,   103.28f,      .0982432f,    4.77694e-4f,
       0.f,          .00274372f,   0.f,          0.f,          .0757809f,
       .171403f,     -.0105205f,   0.f,          0.f,          0.f,
       0.f,          -8.73348f,    -.00581094f,  0.f,          -.00814944f,
       0.f,          0.f,          .0517255f,    -15.3028f,    -.00348932f,
       9.61771e-4f,  .00557732f,   -4.5418e-4f,  .0988213f,    .0940456f,
       -.0318797f,   0.f,          0.f,          0.f,          .00232122f,
       -.0060022f,   2.77654e-5f,  -.00322019f,  0.f,          -.00378551f,
       -.00334809f,  -.00170668f,  0.f,          6361.84f,     0.f,
       .00159986f,   -.00388204f,  -.00164825f,  -74.7955f,    -.010536f,
       -.00945723f,  -.00159824f,  -7.0673e-4f,  -.0168513f,   -.113023f,
       -.0636637f,   -13770.9f,    0.f,          0.f,          0.f,
       -15236.8f,    -.00586061f,  -.00253108f,  0.f,          -2548.37f,
       -.00328988f,  0.f,          0.f,          -.00276364f,  .00967923f,
       0.f,          0.f,          0.f,          0.f,          0.f,
       .0434255f,    .011402f,     -.00618447f,  0.f,          0.f,
       -.302568f,    -.0327694f,   -67.1589f,    -.0022834f,   0.f,
       .0030623f,    -.00465113f,  -.00973421f,  .0128326f,    .00788553f,
       .00797197f,   -.012076f,    -.00767547f,  -.00120755f,  -.0298523f,
       -.012656f,    0.f,          -.056835f,    -.0153039f,   0.f,
       0.f,          0.f,          0.f,          0.f,          0.f,
       0.f,          .00242911f,   -.00401347f,  -.00219074f,  3.11281f,
       .00323251f,   -.00639523f,  -.00663069f,  -3.04403e-4f, -.0040192f,
       -.00118708f,  4.15211f,     -.201896f,    0.f,          0.f,
       0.f,          0.f,          0.f,          0.f,          0.f,
       0.f,          0.f,          0.f,          0.f,          0.f,
       0.f,          0.f,          0.f,          0.f,          0.f,
       1.06903f,     3.77113e-4f,  0.f,          0.f,          0.f,
       .0898481f,    -23.6325f,    .020818f,     139.638f,     -.119444f,
       -8.45398f,    -3.99776e-6f, 0.f,          .0036621f,    -.00178929f,
       .0190412f,    -.0392257f,   .00632343f,   .00548144f,   0.f,
       0.f,          0.f,          0.f,          0.f,          -.00243022f,
       .976619f,     5.68478e-4f,  .00582026f,   0.f,          .00621998f,
       0.f,          0.f,          .0107674f,    89.382f,      -.0192414f,
       -8.45398f,    0.f,          0.f,          -.02002f,     -.00195833f,
       -.00938391f,  .013148f,     -.00260147f,  -8.08556e-4f, 5.11651e-5f,
       .00255717f,   0.f,          .00466814f,   .00664196f,   0.f,
       .998594f,     1.90038e-4f,  0.f,          -.0243825f,   0.f,
       0.f,          0.f,          0.f,          0.f,          .0522105f,
       -8.45398f,    0.f,          0.f,          0.f,          0.f,
       .00767271f,   .00564539f,   -.00270623f,  -5.26454e-4f, .00137075f,
       .0013306f,    0.f,          0.f,          0.f,          0.f,
       .949197f,     0.f,          0.f,          -.0768008f,   0.f,
       0.f,          0.f,          -.0137993f,   -1.40136f,    .120481f,
       -8.45398f,    0.f,          0.f,          0.f,          0.f,
       .00987746f,   .0017533f,    -6.88835e-4f, .00287022f,   0.f,
       0.f,          .0744513f,    0.f,          0.f,          0.f,
       .15284f,      0.f,          0.f,          1.16252f,     0.f,
       0.f,          0.f,          0.f,          0.f,          -.64919f,
       -8.45398f,    0.f,          0.f,          0.f,          0.f,
       -.0584949f,   -.102105f,    .0299153f,    -.0486227f,   0.f,
       0.f,          0.f,          0.f,          0.f,          0.f,
       0.f,          0.f,          0.f,          0.f,          0.f,
       0.f,          0.f,          0.f,          0.f,          0.f,
       0.f,          0.f,          0.f,          0.f,          0.f,
       0.f,          0.f,          0.f,          0.f,          0.f,
       0.f,          0.f,          0.f,          0.f,          0.f,
       .931402f,     .137976f,     0.f,          3.23736e-4f,  0.f,
       -.00910906f,  .0707506f,    0.f,          -.051665f,    .0689755f,
       0.f,          0.f,          0.f,          -8.45398f,    0.f,
       .028114f,     0.f,          73.6009f,     .0596604f,    0.f,
       0.f,          -.00151792f,  0.f,          0.f,          .132397f,
       .213315f,     0.f,          0.f,          0.f,          0.f,
       0.f,          9.48758f,     .00884541f,   0.f,          0.f,
       0.f,          0.f,          0.f,          0.f,          0.f,
       0.f,          0.f,          0.f,          .113139f,     .169134f,
       .0145192f,    0.f,          0.f,          0.f,          0.f,
       .0107906f,    2.99942e-5f,  0.f,          0.f,          0.f,
       0.f,          0.f,          0.f,          0.f,          0.f,
       0.f,          0.f,          0.f,          0.f,          -.014893f,
       -.00787184f,  0.f,          0.f,          0.f,          0.f,
       0.f,          0.f,          0.f,          0.f,          0.f,
       0.f,          0.f,          0.f,          0.f,          0.f,
       0.f,          0.f,          0.f,          0.f,          0.f,
       0.f,          0.f,          0.f,          0.f,          0.f,
       -.068342f,    -.0441778f,   0.f,          0.f,          0.f,
       0.f,          .022973f,     0.f,          0.f,          0.f,
       0.f,          0.f,          0.f,          0.f,          0.f,
       0.f,          0.f,          0.f,          0.f,          0.f,
       0.f,          0.f,          0.f,          0.f,          0.f,
       0.f,          0.f,          0.f,          0.f,          0.f,
       ...
       0.f,          0.f,          0.f,          0.f,          0.f,
       0.f,          0.f,          0.f,          0.f,          0.f,
       .868053f,     .236364f,     .134306f,     .0103086f,    0.f,
       -.00379164f,  -.157806f,    0.f,          -.0587644f,   -.312508f,
       0.f,          .0437387f,    -.0354091f,   -22.3636f,    0.f,
       -.0533976f,   0.f,          114.091f,     .0517497f,    0.f,
       0.f,          0.f,          0.f,          0.f,          .132397f,
       .213315f,     0.f,          0.f,          0.f,          0.f,
       0.f,          342.702f,     .0157033f,    0.f,          0.f,
       0.f,          0.f,          0.f,          0.f,          -.00366278f,
       -.00116193f,  0.f,          0.f,          .113139f,     .169134f,
       .0178431f,    0.f,          0.f,          0.f,          0.f,
       .0162864f,    3.16963e-5f,  .0127968f,    0.f,          0.f,
       -.00704599f,  .00207921f,   .0063666f,    22994.f,      0.f,
       .0127833f,    -.00208036f,  -.0046182f,   -62.9391f,    -.0120745f,
       .0136675f,    .0136011f,    -.00537162f,  0.f,          0.f,
       0.f,          0.f,          0.f,          0.f,          0.f,
       19250.9f,     .00835522f,   .00419439f,   0.f,          12036.6f,
       0.f,          0.f,          0.f,          -.0100034f,   -.00233267f,
       .00972374f,   0.f,          0.f,          0.f,          0.f,
       -.0265079f,   -.0209125f,   -.0109465f,   0.f,          0.f,
       0.f,          .0217252f,    -71.2385f,    -.00189428f,  0.f,
       -.00602006f,  .0169058f,    0.f,          0.f,          0.f,
       0.f,          0.f,          0.f,          0.f,          .0290646f,
       .00348971f,   0.f,          .0501174f,    .0550595f,    0.f,
       -.00955897f,  0.f,          0.f,          -1516.93f,    0.f,
       0.f,          .0129306f,    .00269567f,   0.f,          3.92243f,
       -.0084769f,   .0116896f,    0.f,          .0148967f,    .00544521f,
       0.f,          5.64918f,     0.f,          -.00772178f,  0.f,
       0.f,          -73.4042f,    0.f,          0.f,          0.f,
       0.f,          0.f,          0.f,          0.f,          0.f,
       0.f,          0.f,          0.f,          0.f,          0.f,
       1.27515f,     -.210472f,    -.177924f,    .2189f,       .0288436f,
       .0190077f,    .291001f,     .0217437f,    -.0105186f,   .436141f,
       .107605f,     .0330755f,    .0400581f,    -9.58051f,    0.f,
       .0154028f,    0.f,          73.4194f,     .049654f,     -.00595906f,
       3.84512e-5f,  -.0136f,      0.f,          0.f,          .132397f,
       .213315f,     -.041661f,    0.f,          0.f,          0.f,
       0.f,          146.276f,     -.0198408f,   0.f,          .013253f,
       0.f,          0.f,          0.f,          0.f,          -1.04687e-4f,
       -.00147562f,  0.f,          0.f,          .113139f,     .169134f,
       -.0126913f,   0.f,          0.f,          0.f,          -.0060837f,
       -.0257587f,   3.19022e-5f,  0.f,          0.f,          .0156644f,
       .010364f,     .00105771f,   0.f,          3579.49f,     0.f,
       -.00125672f,  .00152783f,   .00130518f,   7.55558f,     -.00920341f,
       -.0209142f,   -.0134106f,   0.f,          -.0483312f,   .08309f,
       .0988009f,    -14114.8f,    0.f,          0.f,          0.f,
       -1055.13f,    0.f,          0.f,          0.f,          0.f,
       0.f,          0.f,          0.f,          .00673442f,   .00201691f,
       0.f,          0.f,          0.f,          0.f,          0.f,
       .0598019f,    .00633298f,   -.00112871f,  0.f,          0.f,
       0.f,          -.0128604f,   0.f,          0.f,          0.f,
       -.0049496f,   -.0136415f,   -.0115039f,   0.f,          0.f,
       0.f,          0.f,          0.f,          0.f,          0.f,
       0.f,          0.f,          0.f,          0.f,          0.f,
       0.f,          0.f,          0.f,          0.f,          0.f,
       0.f,          -.0058686f,   -.00141732f,  .00213697f,   2.63845f,
       -.00834186f,  -.0187336f,   -.019087f,    -.0080381f,   -.00284279f,
       .00256722f,   1.71429f,     0.f,          0.f,          0.f,
       0.f,          0.f,          0.f,          0.f,          0.f,
       0.f,          0.f,          0.f,          0.f,          0.f,
       0.f,          0.f,          0.f,          0.f,          0.f,
       57.3587f,     -.398747f,    0.f,          -.529554f,    -.00582186f,
       .0714177f,    -.679279f,    -.167715f,    -.0642434f,   -.211569f,
       -.159922f,    -1.71024e-4f, -.115885f,    6.51603f,     0.f,
       -.176683f,    .0650395f,    1.43504f,     .0928208f,    .00511662f,
       0.f,          .00995121f,   0.f,          0.f,          .132397f,
       .213315f,     .101451f,     0.f,          0.f,          0.f,
       0.f,          56.7667f,     .00238192f,   0.f,          -.018824f,
       0.f,          0.f,          .0476218f,    23.5206f,     .00475901f,
       .00576162f,   .0151815f,    -.019273f,    .113139f,     .169134f,
       -.0288771f,   0.f,          0.f,          0.f,          .00118418f,
       -.00368927f,  3.14704e-5f,  .00882198f,   0.f,          -.0192562f,
       -.00258674f,  -.0219913f,   0.f,          4386.55f,     0.f,
       .00760126f,   .00259438f,   .0017231f,    77.9204f,     7.97786e-4f,
       -.0077051f,   .00190982f,   .00272707f,   .0101016f,    .116537f,
       -.00312236f,  13978.3f,     0.f,          0.f,          0.f,
       -1307.12f,    0.f,          0.f,          0.f,          0.f,
       0.f,          0.f,          0.f,          -.00320544f,  -.020697f,
       0.f,          0.f,          0.f,          0.f,          0.f,
       .015901f,     -.00191427f,  -.0342829f,   0.f,          0.f,
       0.f,          -.0345379f,   89.4518f,     .00171556f,   0.f,
       -.00765278f,  -2.08987e-4f, -.0157393f,   0.f,          0.f,
       0.f,          0.f,          0.f,          0.f,          0.f,
       0.f,          0.f,          0.f,          0.f,          0.f,
       0.f,          0.f,          0.f,          0.f,          0.f,
       0.f,          -.00860673f,  -.0119922f,   -.00646356f,  -3.00107f,
       -.00932511f,  -.0150205f,   -.00867835f,  -.00764801f,  -.0131495f,
       -.0067672f,   -1.82396f,    0.f,          0.f,          0.f,
       0.f,          0.f,          0.f,          0.f,          0.f,
       0.f,          0.f,          0.f,          0.f,          0.f,
       0.f,          0.f,          0.f,          0.f,          0.f,
       .951363f,     -.0467542f,   .12026f,      0.f,          0.f,
       .0191357f,    0.f,          0.f,          .00125429f,   -.13324f,
       0.f,          0.f,          0.f,          -8.45398f,    0.f,
       0.f,          0.f,          0.f,          0.f,          0.f,
       0.f,          .00252317f,   0.f,          -.00973404f,  .132397f,
       .213315f,     0.f,          0.f,          0.f,          0.f,
       0.f,          0.f,          0.f,          -7.18482e-4f, 0.f,
       0.f,          0.f,          0.f,          0.f,          0.f,
       0.f,          .00787683f,   -.00233698f,  .113139f,     .169134f,
       0.f,          0.f,          0.f,          0.f,          0.f,
       0.f,          0.f,          0.f,          0.f,          0.f,
       0.f,          0.f,          0.f,          0.f,          0.f,
       0.f,          0.f,          0.f,          0.f,          0.f,
       ...
       0.f,          0.f,          0.f,          0.f,          0.f,
       0.f,          0.f,          0.f,          0.f,          0.f,
       .933804f,     5.47446f,     .153263f,     .919303f,     16.4109f,
       4.27083f,     0.f,          0.f,          0.f,          0.f,
       0.f,          0.f,          0.f,          0.f,          0.f,
       0.f,          0.f,          0.f,          0.f,          0.f,
       0.f,          0.f,          0.f,          0.f,          0.f,
       1.15897f,     .471094f,     1.09459f,     5.25012f,     1.f,
       1.f,          1.03999f,     .767132f,     1.10514f,     1.75636f,
       1.10845f,     2.33439f,     .796532f,     4.3152f,      4.073f,
       1.01885f,     .239547f,     2.53791e-6f,  .842931f,     1.04192f,
       2.00202f,     1.f,          1.f,          1.f,          1.f};

   short i;

   for (i = 0; i < 2; i++)
      parmb_86.e_1[i] = parmb_86_e1[i];
   for (i = 0; i < 64; i++)
      lower5_.e_1[i] = lower5_e1[i];
   for (i = 0; i < 1400; i++)
...
double MSIS86(long Year, long DOY, long Hour, long Minute, double Second,
   ...
   gts5_(&IYD, &SEC, &ALT, &GLAT, &GLONG, &STL, &F107A, &F107, &AP, &MASS, D,
         T);
