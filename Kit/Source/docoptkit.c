...
"  -d DIR --defaultdir=DIR       Top directory for Custom Input, Output, and Model Files\n"
"  -i DIR --indir=DIR            Directory for Custom Input Files, overrides --defaultdir\n"
"  -o DIR --outdir=DIR           Directory for Simulation Output FILES, overrides --defaultdir\n"
"  -m DIR --modeldir=DIR         Directory for Custom Model Files, overrides --defaultdir\n"
"  -g BOOL --graphics=BOOLEAN    Force enable (TRUE, 1) or disable (FALSE, 0) graphics regardless of what is in the input file.\n"
"\n"
"";
