...
void ReadFromSocket(SOCKET Socket, struct AcType *AC)
{
   ...
   while (!Done) {
      ...
      if (sscanf(line, "SC[%ld].AC.Gyro[%ld].Rate = %le", &Isc, &i,
                 &DbleVal[0]) == 3) {
         if (Isc == AC->ID) {
      ...
      if (sscanf(line, "SC[%ld].AC.MAG[%ld].Field = %le", &Isc, &i,
                 &DbleVal[0]) == 3) {
         if (Isc == AC->ID) {
      ...
      if (sscanf(line, "SC[%ld].AC.CSS[%ld].Valid = %ld", &Isc, &i,
                 &LongVal[0]) == 3) {
         if (Isc == AC->ID) {
      ...
      if (sscanf(line, "SC[%ld].AC.CSS[%ld].Illum = %le", &Isc, &i,
                 &DbleVal[0]) == 3) {
         if (Isc == AC->ID) {
      ...
      if (sscanf(line, "SC[%ld].AC.FSS[%ld].Valid = %ld", &Isc, &i,
                 &LongVal[0]) == 3) {
         if (Isc == AC->ID) {
      ...
      if (sscanf(line, "SC[%ld].AC.ST[%ld].Valid = %ld", &Isc, &i,
                 &LongVal[0]) == 3) {
         if (Isc == AC->ID) {
      ...
      if (sscanf(line, "SC[%ld].AC.GPS[%ld].Valid = %ld", &Isc, &i,
                 &LongVal[0]) == 3) {
         if (Isc == AC->ID) {
      ...
      if (sscanf(line, "SC[%ld].AC.GPS[%ld].Week = %ld", &Isc, &i,
                 &LongVal[0]) == 3) {
         if (Isc == AC->ID) {
      ...
      if (sscanf(line, "SC[%ld].AC.GPS[%ld].Sec = %le", &Isc, &i,
                 &DbleVal[0]) == 3) {
         if (Isc == AC->ID) {
      ...
      if (sscanf(line, "SC[%ld].AC.GPS[%ld].Lng = %le", &Isc, &i,
                 &DbleVal[0]) == 3) {
         if (Isc == AC->ID) {
      ...
      if (sscanf(line, "SC[%ld].AC.GPS[%ld].Lat = %le", &Isc, &i,
                 &DbleVal[0]) == 3) {
         if (Isc == AC->ID) {
      ...
      if (sscanf(line, "SC[%ld].AC.GPS[%ld].Alt = %le", &Isc, &i,
                 &DbleVal[0]) == 3) {
         if (Isc == AC->ID) {
      ...
      if (sscanf(line, "SC[%ld].AC.Accel[%ld].Acc = %le", &Isc, &i,
                 &DbleVal[0]) == 3) {
         if (Isc == AC->ID) {
      ...
      if (AC->ParmLoadEnabled) {
         ...
         if (sscanf(line,
                    "SC[%ld].AC.G[%ld].CGiBi = %le %le %le %le %le %le %le %le "
                    "%le",
         ...
         if (sscanf(line,
                    "SC[%ld].AC.G[%ld].CBoGo = %le %le %le %le %le %le %le %le "
                    "%le",
                    &Isc, &i, &DbleVal[0], &DbleVal[1], &DbleVal[2],
                    &DbleVal[3], &DbleVal[4], &DbleVal[5], &DbleVal[6],
                    &DbleVal[7], &DbleVal[8]) == 11) {
         ...
         if (sscanf(line, "SC[%ld].AC.ThrCtrl.Kv = %le", &Isc, &DbleVal[0]) ==
             2) {
            if (Isc == AC->ID) {
         ...
         if (sscanf(line, "SC[%ld].AC.ThrCtrl.Kp = %le", &Isc, &DbleVal[0]) ==
             2) {
            if (Isc == AC->ID) {
