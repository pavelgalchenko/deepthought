...
void ReadFromCmd(void)
{
   ...
   if (sscanf(line, "SC[%ld].AC.ParmLoadEnabled = %ld", &Isc, &LongVal[0]) ==
       2) {
      if (Isc == AC->ID) {
   ...
   if (sscanf(line, "SC[%ld].AC.ParmDumpEnabled = %ld", &Isc, &LongVal[0]) ==
       2) {
      if (Isc == AC->ID) {
   ...
   if (sscanf(line, "SC[%ld].AC.Gyro[%ld].Rate = %le", &Isc, &i, &DbleVal[0]) ==
       3) {
      if (Isc == AC->ID) {
   ...
   if (sscanf(line, "SC[%ld].AC.MAG[%ld].Field = %le", &Isc, &i, &DbleVal[0]) ==
       3) {
      if (Isc == AC->ID) {
   ...
   if (sscanf(line, "SC[%ld].AC.CSS[%ld].Valid = %ld", &Isc, &i, &LongVal[0]) ==
       3) {
      if (Isc == AC->ID) {
   ...
   if (sscanf(line, "SC[%ld].AC.CSS[%ld].Illum = %le", &Isc, &i, &DbleVal[0]) ==
       3) {
      if (Isc == AC->ID) {
   ...
   if (sscanf(line, "SC[%ld].AC.FSS[%ld].Valid = %ld", &Isc, &i, &LongVal[0]) ==
       3) {
      if (Isc == AC->ID) {
   ...
   if (sscanf(line, "SC[%ld].AC.FSS[%ld].SunAng = %le %le", &Isc, &i,
              &DbleVal[0], &DbleVal[1]) == 4) {
      if (Isc == AC->ID) {
   ...
   if (sscanf(line, "SC[%ld].AC.ST[%ld].Valid = %ld", &Isc, &i, &LongVal[0]) ==
       3) {
      if (Isc == AC->ID) {
   ...
   if (sscanf(line, "SC[%ld].AC.GPS[%ld].Valid = %ld", &Isc, &i, &LongVal[0]) ==
       3) {
      if (Isc == AC->ID) {
   ...
   if (sscanf(line, "SC[%ld].AC.GPS[%ld].Rollover = %ld", &Isc, &i,
              &LongVal[0]) == 3) {
      if (Isc == AC->ID) {
   ...
   if (sscanf(line, "SC[%ld].AC.GPS[%ld].Week = %ld", &Isc, &i, &LongVal[0]) ==
       3) {
      if (Isc == AC->ID) {
   ...
   if (sscanf(line, "SC[%ld].AC.GPS[%ld].Sec = %le", &Isc, &i, &DbleVal[0]) ==
       3) {
      if (Isc == AC->ID) {
   ...
   if (sscanf(line, "SC[%ld].AC.GPS[%ld].Lng = %le", &Isc, &i, &DbleVal[0]) ==
       3) {
      if (Isc == AC->ID) {
   ...
   if (sscanf(line, "SC[%ld].AC.GPS[%ld].Lat = %le", &Isc, &i, &DbleVal[0]) ==
       3) {
      if (Isc == AC->ID) {
   ...
   if (sscanf(line, "SC[%ld].AC.GPS[%ld].Alt = %le", &Isc, &i, &DbleVal[0]) ==
       3) {
      if (Isc == AC->ID) {
   ...
   if (sscanf(line, "SC[%ld].AC.GPS[%ld].WgsLng = %le", &Isc, &i,
              &DbleVal[0]) == 3) {
      if (Isc == AC->ID) {
   ...
   if (sscanf(line, "SC[%ld].AC.GPS[%ld].WgsLat = %le", &Isc, &i,
              &DbleVal[0]) == 3) {
      if (Isc == AC->ID) {
   ...
   if (sscanf(line, "SC[%ld].AC.GPS[%ld].WgsAlt = %le", &Isc, &i,
              &DbleVal[0]) == 3) {
      if (Isc == AC->ID) {
   ...
   if (sscanf(line, "SC[%ld].AC.Accel[%ld].Acc = %le", &Isc, &i, &DbleVal[0]) ==
       3) {
      if (Isc == AC->ID) {
   ...
   if (sscanf(line, "SC[%ld].AC.Whl[%ld].H = %le", &Isc, &i, &DbleVal[0]) ==
       3) {
      if (Isc == AC->ID) {
   ...
   if (AC->ParmLoadEnabled) {
      ...
      if (sscanf(line, "SC[%ld].AC.EchoEnabled = %ld", &Isc, &LongVal[0]) ==
          2) {
         if (Isc == AC->ID) {
      ...
      if (sscanf(line, "SC[%ld].AC.Ngyro = %ld", &Isc, &LongVal[0]) == 2) {
         if (Isc == AC->ID) {
            AC->Ngyro = LongVal[0];
         }
      }
      ...
      if (sscanf(line, "SC[%ld].AC.TwoPi = %le", &Isc, &DbleVal[0]) == 2) {
         if (Isc == AC->ID) {
            AC->TwoPi = DbleVal[0];
         }
      }
      ...
      if (sscanf(line, "SC[%ld].AC.B[%ld].mass = %le", &Isc, &i, &DbleVal[0]) ==
          3) {
         if (Isc == AC->ID) {
      ...
      if (sscanf(line,
                 "SC[%ld].AC.B[%ld].MOI = %le %le %le %le %le %le %le %le %le",
                 &Isc, &i, &DbleVal[0], &DbleVal[1], &DbleVal[2], &DbleVal[3],
                 &DbleVal[4], &DbleVal[5], &DbleVal[6], &DbleVal[7],
                 &DbleVal[8]) == 11) {
         if (Isc == AC->ID) {
      ...
      if (sscanf(
              line,
              "SC[%ld].AC.G[%ld].CGiBi = %le %le %le %le %le %le %le %le %le",
              &Isc, &i, &DbleVal[0], &DbleVal[1], &DbleVal[2], &DbleVal[3],
              &DbleVal[4], &DbleVal[5], &DbleVal[6], &DbleVal[7],
              &DbleVal[8]) == 11) {
         if (Isc == AC->ID) {
      ...
      if (sscanf(
              line,
              "SC[%ld].AC.G[%ld].CBoGo = %le %le %le %le %le %le %le %le %le",
              &Isc, &i, &DbleVal[0], &DbleVal[1], &DbleVal[2], &DbleVal[3],
              &DbleVal[4], &DbleVal[5], &DbleVal[6], &DbleVal[7],
              &DbleVal[8]) == 11) {
         if (Isc == AC->ID) {
      ...
      if (sscanf(line, "SC[%ld].AC.G[%ld].AngRateGain = %le %le %le", &Isc, &i,
                 &DbleVal[0], &DbleVal[1], &DbleVal[2]) == 5) {
         if (Isc == AC->ID) {
      ...
      if (sscanf(line, "SC[%ld].AC.G[%ld].PosRateGain = %le %le %le", &Isc, &i,
                 &DbleVal[0], &DbleVal[1], &DbleVal[2]) == 5) {
         if (Isc == AC->ID) {
      ...
      if (sscanf(line, "SC[%ld].AC.G[%ld].MaxAngRate = %le %le %le", &Isc, &i,
                 &DbleVal[0], &DbleVal[1], &DbleVal[2]) == 5) {
         if (Isc == AC->ID) {
      ...
      if (sscanf(line, "SC[%ld].AC.G[%ld].MaxPosRate = %le %le %le", &Isc, &i,
                 &DbleVal[0], &DbleVal[1], &DbleVal[2]) == 5) {
         if (Isc == AC->ID) {
      ...
      if (sscanf(line,
                 "SC[%ld].AC.FSS[%ld].CB = %le %le %le %le %le %le %le %le %le",
                 &Isc, &i, &DbleVal[0], &DbleVal[1], &DbleVal[2], &DbleVal[3],
                 &DbleVal[4], &DbleVal[5], &DbleVal[6], &DbleVal[7],
                 &DbleVal[8]) == 11) {
         if (Isc == AC->ID) {
      ...
      if (sscanf(line,
                 "SC[%ld].AC.ST[%ld].CB = %le %le %le %le %le %le %le %le %le",
                 &Isc, &i, &DbleVal[0], &DbleVal[1], &DbleVal[2], &DbleVal[3],
                 &DbleVal[4], &DbleVal[5], &DbleVal[6], &DbleVal[7],
                 &DbleVal[8]) == 11) {
         if (Isc == AC->ID) {
      ...
      if (sscanf(line, "SC[%ld].AC.Whl[%ld].J = %le", &Isc, &i, &DbleVal[0]) ==
          3) {
         if (Isc == AC->ID) {
      ...
      if (sscanf(line, "SC[%ld].AC.IssCtrl.Kr = %le %le %le", &Isc, &DbleVal[0],
                 &DbleVal[1], &DbleVal[2]) == 4) {
         if (Isc == AC->ID) {
      ...
      if (sscanf(line, "SC[%ld].AC.IssCtrl.Kp = %le %le %le", &Isc, &DbleVal[0],
                 &DbleVal[1], &DbleVal[2]) == 4) {
         if (Isc == AC->ID) {
      ...
      if (sscanf(line, "SC[%ld].AC.IssCtrl.Tmax = %le", &Isc, &DbleVal[0]) ==
          2) {
         if (Isc == AC->ID) {
      ...
      if (sscanf(line, "SC[%ld].AC.CmgCtrl.Kr = %le %le %le", &Isc, &DbleVal[0],
                 &DbleVal[1], &DbleVal[2]) == 4) {
         if (Isc == AC->ID) {
      ...
      if (sscanf(line, "SC[%ld].AC.CmgCtrl.Kp = %le %le %le", &Isc, &DbleVal[0],
                 &DbleVal[1], &DbleVal[2]) == 4) {
         if (Isc == AC->ID) {
      ...
      if (sscanf(line, "SC[%ld].AC.ThrCtrl.Kw = %le %le %le", &Isc, &DbleVal[0],
                 &DbleVal[1], &DbleVal[2]) == 4) {
         if (Isc == AC->ID) {
      ...
      if (sscanf(line, "SC[%ld].AC.ThrCtrl.Kv = %le", &Isc, &DbleVal[0]) == 2) {
         if (Isc == AC->ID) {
            AC->ThrCtrl.Kv = DbleVal[0];
         }
      }

      if (sscanf(line, "SC[%ld].AC.ThrCtrl.Kp = %le", &Isc, &DbleVal[0]) == 2) {
         if (Isc == AC->ID) {
            AC->ThrCtrl.Kp = DbleVal[0];
         }
      }

      if (sscanf(line, "SC[%ld].AC.CfsCtrl.Kr = %le %le %le", &Isc, &DbleVal[0],
                 &DbleVal[1], &DbleVal[2]) == 4) {
         if (Isc == AC->ID) {
      ...
      if (sscanf(line, "SC[%ld].AC.CfsCtrl.Kp = %le %le %le", &Isc, &DbleVal[0],
                 &DbleVal[1], &DbleVal[2]) == 4) {
         if (Isc == AC->ID) {
      ...
      if (sscanf(line, "SC[%ld].AC.CfsCtrl.Kunl = %le", &Isc, &DbleVal[0]) ==
          2) {
         if (Isc == AC->ID) {
